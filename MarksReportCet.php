...
<div class="content-wrapper pb-0">
    <center>
    <h3 class="badge bg-info">Marks Report CET</h3>


<form action="MarksListCet" method="POST" >
...
<div class="row">
    ...
    <div class="col-lg-3">
    EXAM/TEST TYPE:- <input type="text" name="test_type" value="CET" readonly id="" class="form-control">
    </div>
</div>
